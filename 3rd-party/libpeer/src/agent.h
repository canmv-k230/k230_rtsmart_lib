...
#ifndef AGENT_MAX_ACTIVE_PAIRS
#define AGENT_MAX_ACTIVE_PAIRS 5
#endif
...
struct Agent {
  ...
  IceCandidatePair* active_pairs[AGENT_MAX_ACTIVE_PAIRS];
  int active_pairs_count;
  ...
  Address turn_peer_addr;
  int turn_relay_ready;
  uint16_t turn_channel;
  int turn_channel_bound;
  uint32_t turn_allocation_time;
