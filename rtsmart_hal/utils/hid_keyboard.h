 ...
 *
 * HID Keyboard Event API - Public interface for userspace
 * Compatible with Linux input subsystem
 */
...
/* Event types - Compatible with Linux input subsystem */
...
#define KEY_REPEAT      2  /* Key repeated (auto-repeat) */

/* HID Keyboard Event - Userspace API */
struct hid_keyboard_event
{
    uint16_t type;      /* Event type (EV_SYN, EV_KEY) */
    uint16_t code;      /* Key code (Linux keycode, see below) */
    uint32_t value;     /* KEY_PRESSED, KEY_RELEASED, or KEY_REPEAT */
};

/* Linux keycodes - Compatible with input-event-codes.h */
